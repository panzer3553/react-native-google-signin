...
public class RNGoogleSigninModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    @Override
    public void onActivityResult(Activity activity, final int requestCode, final int resultCode, final Intent intent) {        if (requestCode == RNGoogleSigninModule.RC_SIGN_IN) {
